...
extern "C" void 			cpc_Set_Version					(int _nCpcVerMajor, int _nCpcVerMinor);
	...
	typedef 	bool			(*FUNC_cpc_Thread_En_Cours)				(); 												extern FUNC_cpc_Thread_En_Cours 			cpc_Thread_En_Cours;
	typedef 	bool			(*FUNC_cpc_supprimer_Thread)			(unsigned int TID, bool force); 					extern FUNC_cpc_supprimer_Thread 			cpc_supprimer_Thread;
	typedef 	bool			(*FUNC_cpc_doevents)					(int temps); 										extern FUNC_cpc_doevents 					cpc_doevents;
	
	typedef 	void			(*FUNC_cpc_ENTRER_SectionCritique)		(); 												extern FUNC_cpc_ENTRER_SectionCritique 		cpc_ENTRER_SectionCritique;
	typedef 	void			(*FUNC_cpc_SORTIR_SectionCritique)		(); 												extern FUNC_cpc_SORTIR_SectionCritique 		cpc_SORTIR_SectionCritique;
#endif	
