...
void ManagedAlloc_exe::ManagedAlloc_(int alloc_max, const char* name)
{
...
int ManagedAlloc_exe::ManagedAlloc_clean()
{
...
bool ManagedAlloc_exe::ManagedFree(void* ptr)
{
...
void* ManagedAlloc_exe::ManagedMalloc(size_t size__)
{
...
void* ManagedAlloc_exe::ManagedCalloc(size_t size__, size_t sizeElem__)
{
	// Chercher un emplacement vide et malloc dedans!
