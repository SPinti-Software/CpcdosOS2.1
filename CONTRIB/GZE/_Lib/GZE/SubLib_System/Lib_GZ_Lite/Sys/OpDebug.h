#if !( defined tHDef_Lib_GZ_Lite_Sys_OpDebug || defined  tHDef_IN_Lib_GZ_Sys_Debug || defined  tHDef_IN_Lib_GZ_Class)
#pragma once
#define tHDef_Lib_GZ_Lite_Sys_OpDebug
#define tHDef_IN_Lib_GZ_Lite_Sys_OpDebug
namespace Lib_GZ_Lite{namespace Sys{class cOpDebug;}}

#include "Lib_GZ_Lite/Lib_GZ_Lite.h"
#include "Lib_GZ/GZ.h"
#include "Lib_GZ/Thread.h"
#include "Lib_GZ/Sys/Debug.h"
namespace Lib_GZ_Lite{namespace Sys{namespace OpDebug{
...
class tApi_Lib_GZ_Lite pOpDebug {
...
class tApi_Lib_GZ_Lite cOpDebug : public Lib_GZ::Sys::cDebug {
...
class tApi_Lib_GZ_Lite csOpDebug : public Lib_GZ::Sys::csDebug  {
...
#undef tHDef_IN_Lib_GZ_Lite_Sys_OpDebug
#endif