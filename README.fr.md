...
## Comment compiler
 ...
 Il est recommandé d'utiliser [VMware workstation player 16](https://dl.cpcdos.net/PRIVATE/share/VMware-player-16.1.0-17198959.exe) et ne pas avoir installé la version pro sur votre machine, au risque d'avoir moins d'options de configuration de votre carte réseau.
