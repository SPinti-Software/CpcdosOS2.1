...
namespace cpinti
{
	...
	void cpinti_Appeler_Scheduler_CPintiCore(unsigned int Temps)
	{
		// PEACE FOR YOUR CPU
		// NP_cpinti_gestionnaire_tache::Gestionnaire_des_taches::Appeler_Scheduler_CPintiCore(Temps);
	}
	...
	void cpinti_Sleep(unsigned int secondes)
	{
		...
		// tv.tv_sec = (time_t) Millisecondes / 1000;
		// tv.tv_usec = (long int) (Millisecondes % 1000) * 1000;
